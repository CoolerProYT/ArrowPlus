...
public class ModEntities {
    ...
    public static final DeferredRegister<EntityDataSerializer<?>> SERIALIZERS = DeferredRegister.create(ForgeRegistries.Keys.ENTITY_DATA_SERIALIZERS, ArrowPlus.MODID);

    public static final RegistryObject<EntityType<ModArrowEntity>> ARROW_PLUS = registerArrow("arrow_plus", ModItems.ARROW_PLUS);

     public static final Supplier<EntityDataSerializer<ArrowData>> ARROW_DATA = SERIALIZERS.register("arrow_data", () -> EntityDataSerializer.simple(ArrowData::encode, ArrowData::decode));
