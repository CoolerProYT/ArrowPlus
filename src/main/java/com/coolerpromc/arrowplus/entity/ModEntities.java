...
public class ModEntities {
    ...
    public static final TrackedDataHandler<ArrowData> ARROW_DATA = TrackedDataHandler.of(ArrowData::encode, ArrowData::decode);
    ...
    public static void register() {
        TrackedDataHandlerRegistry.register(ARROW_DATA);
    }
}
