...
public class ModArrowRenderer extends EntityRenderer<ModArrowEntity, ModArrowRenderState> {
    ...
    public void render(ModArrowRenderState renderState, MatrixStack matrixStack, OrderedRenderCommandQueue orderedRenderCommandQueue, CameraRenderState cameraRenderState) {
        ...
        orderedRenderCommandQueue.submitModel(this.model, renderState, matrixStack, RenderLayer.getEntityCutout(BODY_TEXTURE), renderState.light, OverlayTexture.DEFAULT_UV, renderState.bodyColor, null, renderState.outlineColor, null);
        orderedRenderCommandQueue.submitModel(this.model, renderState, matrixStack, RenderLayer.getEntityCutout(HEAD_TEXTURE), renderState.light, OverlayTexture.DEFAULT_UV, renderState.headColor, null, renderState.outlineColor, null);
        orderedRenderCommandQueue.submitModel(this.model, renderState, matrixStack, RenderLayer.getEntityCutout(FEATHER_TEXTURE), renderState.light, OverlayTexture.DEFAULT_UV, renderState.featherColor, null, renderState.outlineColor, null);
        matrixStack.pop();
