...
public class ModRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        SpecialRecipeBuilder.special(TippedArrowRecipe::new).save(this.output, ResourceKey.create(Registries.RECIPE, ResourceLocation.fromNamespaceAndPath(ArrowPlus.MODID, "tipped_arrow_recipe")));
        ...
        lookupProvider.lookupOrThrow(ModRegistries.ARROW_DATA_KEY).listElements().forEach(holder -> {
            ConditionalRecipe.builder()
                    .condition(new ModLoadedCondition("fletchingrecipe"))
                    .recipe(output1 -> {
                        ...
                        FletchingRecipeBuilder.builder()
                                ...
                                .output(new ItemStack(ModItems.ARROW_PLUS.get().builtInRegistryHolder(), arrowData.outputAmount() * 2, DataComponentPatch.builder().set(ModDataComponents.ARROW_DATA.get(), holder).build()))
                    ...
                    .save(output, ResourceLocation.fromNamespaceAndPath(ArrowPlus.MODID, "fletching/" + holder.unwrapKey().get().location().getPath() + "_arrow"));
        });
    }
