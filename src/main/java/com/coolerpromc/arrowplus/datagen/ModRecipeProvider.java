    ...
    protected void buildRecipes() {
        ...
        lookupProvider.lookupOrThrow(ModRegistries.ARROW_DATA_KEY).listElements().forEach(holder -> {
            ...
            FletchingRecipeBuilder.builder()
                    ...
                    .save(output.withConditions(NeoForgeConditions.modLoaded("fletchingrecipe")), ResourceKey.create(Registries.RECIPE, Identifier.fromNamespaceAndPath(ArrowPlus.MODID, "fletching/" + holder.getKey().identifier().getPath() + "_arrow")));
        });
    }
