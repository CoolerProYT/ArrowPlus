...
public class ModModelProvider extends ModelProvider {
    ...
    protected ItemModelGenerators getItemModelGenerators(ItemInfoCollector items, SimpleModelCollector models) {
        return new ItemModelGenerators(items, models){
            ...
            public void run() {
                ...
                // Sticks
                this.itemModelOutput.accept(ModItems.COPPER_STICK.get(), ItemModelUtils.tintedModel(ModelTemplates.FLAT_ITEM.create(ModItems.COPPER_STICK.get(), TextureMapping.layer0(Identifier.fromNamespaceAndPath(ArrowPlus.MODID, "item/stick")), this.modelOutput), new StickTintSource(-1)));
                this.itemModelOutput.accept(ModItems.IRON_STICK.get(), ItemModelUtils.tintedModel(ModelTemplates.FLAT_ITEM.create(ModItems.IRON_STICK.get(), TextureMapping.layer0(Identifier.fromNamespaceAndPath(ArrowPlus.MODID, "item/stick")), this.modelOutput), new StickTintSource(-1)));
                this.itemModelOutput.accept(ModItems.GOLD_STICK.get(), ItemModelUtils.tintedModel(ModelTemplates.FLAT_ITEM.create(ModItems.GOLD_STICK.get(), TextureMapping.layer0(Identifier.fromNamespaceAndPath(ArrowPlus.MODID, "item/stick")), this.modelOutput), new StickTintSource(-1)));
                this.itemModelOutput.accept(ModItems.DIAMOND_STICK.get(), ItemModelUtils.tintedModel(ModelTemplates.FLAT_ITEM.create(ModItems.DIAMOND_STICK.get(), TextureMapping.layer0(Identifier.fromNamespaceAndPath(ArrowPlus.MODID, "item/stick")), this.modelOutput), new StickTintSource(-1)));
                this.itemModelOutput.accept(ModItems.EMERALD_STICK.get(), ItemModelUtils.tintedModel(ModelTemplates.FLAT_ITEM.create(ModItems.EMERALD_STICK.get(), TextureMapping.layer0(Identifier.fromNamespaceAndPath(ArrowPlus.MODID, "item/stick")), this.modelOutput), new StickTintSource(-1)));
                this.itemModelOutput.accept(ModItems.NETHERITE_STICK.get(), ItemModelUtils.tintedModel(ModelTemplates.FLAT_ITEM.create(ModItems.NETHERITE_STICK.get(), TextureMapping.layer0(Identifier.fromNamespaceAndPath(ArrowPlus.MODID, "item/stick")), this.modelOutput), new StickTintSource(-1)));

                // Feather
                this.itemModelOutput.accept(ModItems.GILDED_FEATHER.get(), ItemModelUtils.tintedModel(ModelTemplates.FLAT_ITEM.create(ModItems.GILDED_FEATHER.get(), TextureMapping.layer0(Identifier.fromNamespaceAndPath(ArrowPlus.MODID, "item/feather")), this.modelOutput), new FeatherTintSource(-1)));
            ...
            private void generateArrow(ItemModelGenerators itemModels, Item item) {
                ...
                Identifier base = ModelTemplates.THREE_LAYERED_ITEM.create(getModelLocation(item, ""), baseMapping, this.modelOutput);
                Identifier tipped = FOUR_LAYERED_ITEM.create(getModelLocation(item, "_tipped"), tippedMapping, this.modelOutput);
    ...
    protected Stream<Item> getKnownItems() {
        return BuiltInRegistries.ITEM.listElements().filter(itemReference -> Optional.of(BuiltInRegistries.ITEM.getKey(itemReference.value())).filter(Identifier -> Identifier.getNamespace().equals(ArrowPlus.MODID)).isPresent()).map(Holder::value);
    }

    @Override
    protected Stream<Block> getKnownBlocks() {
        return BuiltInRegistries.BLOCK.listElements().filter(itemReference -> Optional.of(BuiltInRegistries.BLOCK.getKey(itemReference.value())).filter(Identifier -> Identifier.getNamespace().equals(ArrowPlus.MODID)).isPresent()).map(Holder::value);
    }
