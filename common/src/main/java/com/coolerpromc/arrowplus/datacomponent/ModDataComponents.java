...
public class ModDataComponents {
    ...
    public static final RegistryHandler<DataComponentType<?>, DataComponentType<Holder<StickData>>> STICK_DATA = Services.REGISTRY.registerDataComponent("stick_data", builder -> builder.persistent(RegistryFileCodec.create(ModRegistries.STICK_DATA_KEY, StickData.CODEC)).networkSynchronized(ByteBufCodecs.holder(ModRegistries.STICK_DATA_KEY, StickData.STREAM_CODEC)));
