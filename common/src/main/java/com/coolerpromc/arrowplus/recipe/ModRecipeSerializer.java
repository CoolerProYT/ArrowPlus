...
public class ModRecipeSerializer {
    public static final RegistryHandler<RecipeSerializer<FeatherRecipe>> FEATHER_RECIPE_SERIALIZER = Services.REGISTRY.registerRecipeSerializer("feather_recipe", FeatherRecipe.SERIALIZER);
    public static final RegistryHandler<RecipeSerializer<StickRecipe>> STICK_RECIPE_SERIALIZER = Services.REGISTRY.registerRecipeSerializer("stick_recipe", StickRecipe.SERIALIZER);
